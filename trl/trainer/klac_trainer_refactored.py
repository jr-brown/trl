...
def standard_loss_fn(
    kl_coef, state_value_prediction, new_ref_log_ratio, micro_batch_return
):
                ...
                for mini_batch_start in range(
                    ...
                    for micro_batch_start in range(
                        ...
                        with accelerator.accumulate(model):
                            ...
                            # Compute loss
                            action_value_function_loss = loss_function_map[
                                self.loss_function
                            ](
                                args.kl_coef,
                                state_value_prediction,
